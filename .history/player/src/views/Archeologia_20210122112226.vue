<template>
    <div :class="$style.container" :style="boardSizes">
        ...
        <Block v-for="(block, index) in gridBoard" :key="index" :styleBlock="block" :index="index" :style="{ width: `${blockWidth}px`, height: `${blockWidth}px` }" @click.native="handlerClick(index)"> </Block>
    </div>
</template>
