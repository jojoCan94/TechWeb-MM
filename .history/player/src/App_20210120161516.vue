<template>
  <div id="app" class="dark"> 
    <div class="bg-white dark:bg-grey-500  font-avenir font-helvetica font-arial font-sans font-serif text-center text-xl text-bold text-blue-900 ">
      ...
      <nav class="bg-grey-100 dark:bg-gray-800 h-20 w-full flex items-center">
        <button class="text-yellow-500 fosus:outline-none h-10 w-10 flex justify-center items-center">
